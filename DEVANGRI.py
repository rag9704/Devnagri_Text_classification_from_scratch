...
class NeuralNet(object):
    def __init__(self,n_output,n_feature,n_hidden=30,l1=0.0,l2=0.0,epochs=500,eta=0.001,alpha=0.0,decrease_const=0.0,shuffle=True,minibatches=1,random_state=None):
...
X_test = np.genfromtxt(r'C:\Users\Rag9704\Documents\devnagri_test_imagee.csv',dtype=int,delimiter=',')
y_test = np.genfromtxt(r'C:\Users\Rag9704\Documents\devnagri_test_label.csv',dtype=int,delimiter=',')

nn = NeuralNet(n_output=46,n_feature=X_train.shape[1],n_hidden=100,l2=0.1,l1 = 0.0,epochs = 1000,alpha = 0.001,decrease_const = 0.00001,shuffle = True,minibatches=50,random_state=1)
...
np.savetxt(r'C:\Users\Rag9704\Documents\devnagri_test1_result.csv',y_test_pred,delimiter=',')
